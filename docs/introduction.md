...
The purpose of this codebook is to provide a structured framework that enables local governments and policymakers to identify priority areas for heat mitigation using spatial and satellite-based analysis. This codebook serves as both a technical guide and a documentation tool, enabling other researchers, policymakers, and local governments to understand and reproduce the team’s workflow. The manual is designed to help users apply the same methodology to their own contexts, enabling them to do:

- Pinpoint areas most in need of heat mitigation actions
- Implement interventions that align with the 3-30-300 framework
...
- Provide a replicable analytical framework for future World Bank applications
...
- Tree canopy and green space access
- Building density
- Social vulnerability considerations (e.g., employment, age, disability)


## Targeted Stakeholders

This project is designed for individuals and organizations working in urban planning, climate change, and social equity.

**Main stakeholders include:**

- City governments and urban planners: to use data for planning green areas, zoning, and cooling strategies
- Environmental and health agencies: to find which neighborhoods are most affected by heat and need more attention
- Community groups and NGOs: to support which neighborhoods that are most affected by heat and need more attention
